...
/*
    ...
    - 평균 응답 시간: 24.67ms
    - 95% 응답 시간(p95): 34.66ms
    - 실패율: 0%
    - 평균 처리 속도: 약 7.97 req/s
    - 총 실행 시간: 약 20분 55초
    - 전송 데이터량: 2.0 MB (요청) / 1.5 MB (응답)

    [결과]
    execution: local
        script: ./load-test/user-create-sequential-test.js
        output: InfluxDBv1 (http://localhost:8086)

    scenarios: (100.00%) 1 scenario, 1 max VUs, 25m30s max duration (incl. graceful stop):
              * user_create_test: 10000 iterations shared among 1 VUs (maxDuration: 25m0s, gracefulStop: 30s)

    █ THRESHOLDS

    http_req_duration
    ✓ 'p(95)<2000' p(95)=34.66ms
    ...
    HTTP
    http_req_duration..............: avg=24.67ms  min=8.88ms   med=24.48ms  max=424.78ms p(90)=32.56ms  p(95)=34.66ms
      { expected_response:true }...: avg=24.67ms  min=8.88ms   med=24.48ms  max=424.78ms p(90)=32.56ms  p(95)=34.66ms
    http_req_failed................: 0.00%  0 out of 10000
    http_reqs......................: 10000  7.97002/s

    EXECUTION
    iteration_duration.............: avg=125.46ms min=109.77ms med=125.16ms max=526.07ms p(90)=133.34ms p(95)=135.51ms
    iterations.....................: 10000  7.97002/s
    vus............................: 1      min=1          max=1
    vus_max........................: 1      min=1          max=1

    NETWORK
    data_received..................: 1.5 MB 1.2 kB/s
    data_sent......................: 2.0 MB 1.6 kB/s

    running (20m54.7s), 0/1 VUs, 10000 complete and 0 interrupted iterations
    user_create_test ✓ [======================================] 1 VUs  20m54.7s/25m0s  10000/10000 shared iters
*/
...
/*
    ...
    - 확인 결과 : 2개 연결 (MySQL 서버와의 활성 커넥션 수)
*/